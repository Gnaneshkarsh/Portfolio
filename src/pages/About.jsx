      ...
      <div className="about">
        <div className="about-container">
          ...
          <div className="about-content">
            ...
            <div className="about-text">
              <p>
                My name is Gnanesh. I'm a <span>curious</span> and{" "}
              ...
              <p>
                ...
                MERN stack to bring concepts to life in a tangible way.
              </p>
            </div>
          </div>
        </div>
        <div className="pfp-container">
          ...
          <div className="profile-links">
            <a
              href="https://www.linkedin.com/in/gnanesh-p-06938026a/"
              target="_blank"
            ...
            <a
              href="https://github.com/Gnanesh211"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
